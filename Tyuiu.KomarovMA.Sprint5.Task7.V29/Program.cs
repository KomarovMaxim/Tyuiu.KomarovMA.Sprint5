...
using Tyuiu.KomarovMA.Sprint5.Task7.V29.Lib;
using System.IO;
namespace Tyuiu.KomarovMA.Sprint5.Task7.V29
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("***************************************************************************");
            Console.WriteLine(ds.LoadDataAndSave(@"C:\Users\masan\SHARP\InPutDataFileTask7V29.txt"));
            Console.ReadKey();
        }
    }
}